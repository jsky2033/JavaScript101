...
An Array-like Object has a length property and uses indexes to access items. NodeLists and Strings are an example of this.
...
- Doing splice(x) would delete everything past the 'x' value!
